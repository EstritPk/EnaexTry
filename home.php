...
?>
    ...
    <body>
        ...
        <div class="card container" style="margin-top: 200px; min-height:540px; max-width:450px;">
            ...
            <button type="button" class="btn btn-outline-primary" onclick="location.href='lista_entrega.php'" style="">Entregas</button><br><br>
            <button type="button" class="btn btn-outline-primary" onclick="location.href='lista_entrega.php'" style="">Agenda</button><br><br>
