...
function modificar()
{
    $sql="UPDATE   solicitud_pro SET codigo_prod='".$_POST['sop']."',cantidad='".$_POST['fcantidad']."',estado=0,fecha_sp='".fechabd(fechahoy())."',descripcion='".$_POST['des_sp']."'  WHERE Id=".$_POST['idoc'];
mysqli_query(conectar(),$sql);
