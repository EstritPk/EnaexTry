...
function modificar()
{
    $sql="UPDATE   solicitud_pro SET codigo_prod='".$_POST['codigo_prod']."',cantidad='".$_POST['fcantidad']."',estado=0,fecha_sp='".fechabd(fechahoy())."',descripcion='".$_post['des_sp']."'  WHERE Id=".$_POST['idoc'];
mysqli_query(conectar(),$sql);
