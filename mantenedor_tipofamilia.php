            ...
            <div class="card-body">
                ...
                <form class="formulario" name="formfam" action="registrar_tipofamilia.php" class="border border-warning" method="POST" enctype="multipart/form-data">
                    ...
                    <select id="categoria" class="form-control" name="categoria" placeholder="Categoria"><br>
                        ...
                        <option name="categoria" value="Herramienta" <?php if (isset($_GET['cod_pro'])) {
                                                                            if ($datosfa['categoria'] == "Herramienta") { ?> selected <?php }
                                                                                                                                                        } ?>>Herrmaienta</option>
                        <option name="categoria" value="Vestimenta" <?php if (isset($_GET['cod_pro'])) {
                                                                        if ($datosfa['categoria'] == "Vestimenta") { ?> selected <?php }
                                                                                                                                                    } ?>>Vestimenta</option>
                        <option name="categoria" value="Aseo" <?php if (isset($_GET['cod_pro'])) {
                                                                    if ($datosfa['categoria'] == "Aseo") { ?> selected <?php }
                                                                                                                                        } ?>>Aseo</option>
                        <option name="categoria" value="Lubricante" <?php if (isset($_GET['cod_pro'])) {
                                                                        if ($datosfa['categoria'] == "Lubricante") { ?> selected <?php }
                                                                                                                                                    } ?>>Lubricante</option>
                    </select><br>
